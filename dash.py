...
background.fill((20,20,30))     # fill the background white
background = background.convert()  # prepare for faster blitting
ballsurface = pygame.Surface((700,80))     # create a rectangular surface for the ball
ballsurface.fill((0,0,0))
#pygame.draw.circle(Surface, color, pos, radius, width=0)
# draw blue filled circle on ball surface
pygame.draw.rect(ballsurface, (200,200,200), (0,10,100,60))
...
pygame.draw.arc(background, (0,150,80),(50,150,700,200), 0, 3.14, 50)
